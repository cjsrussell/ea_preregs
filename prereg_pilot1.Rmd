...
Across 3 stages we will examine variables which have been argued in popular and scientfiic discourse to cause belief and non-belief. In this initial pilot we will look at the largest number of varaibles in order to test some of the clearest hypotheses and to run explanatory tests to exclude possible variables for the later stages of the project which will have larger samples and a greater proportion of confirmatory tests.


Pre-registrations for this initial pilot, and follow on pilots can be found on our Figshare (insert link), and on my personal GitHub (insert link).
